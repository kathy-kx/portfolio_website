    ...
    <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
        ...
        <div className='z-10'>
            ...
            <p className='text-[#ADB7BE] mb-4 max-w-md'>
                ...
                Whether you have a project in mind, you have a question, or just want to say hello, feel free to reach out! I'll get back to you as soon as possible.
            </p>
            <div className='socials flex flex-row gap-2'>
                <Link href="https://github.com/kathy-kx">
                    <Image src={GithubIcon} alt="Github Icon" width={24} height={24} />
                </Link>
                <Link href="https://www.linkedin.com/in/kzhu011">
            ...
            <form className='flex flex-col' onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                    ...
                    <input
                        ...
                        className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-3 focus:outline-none focus:ring-2 focus:ring-[#0070f3]'
                    />
                </div>
